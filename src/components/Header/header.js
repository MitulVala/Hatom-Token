...
function Header(props) {
  ...
  const { changeThemeMode, isDarkModeOn } = useContext(ThemeModeContext);
      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <Typography className="navLink">Governance</Typography>
            <Typography className="navLink">Prices</Typography>
            <Typography className="navLink">Docs</Typography>
            <Typography className="navLink">Home Token</Typography>
            <FormControlLabel
              control={
                <MaterialUISwitch
                  sx={{ m: 1 }}
                  onChange={() => {
                    changeThemeMode(!isDarkModeOn);
                  }}
                />
              }
            />
